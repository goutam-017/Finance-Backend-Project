...
3. View profile           →  GET   /api/auth/user_profile/    → use access_token
4. Create admin           →  py manage.py createsuperuser
5. Login as admin         →  POST  /api/auth/login/           → copy admin access_token
